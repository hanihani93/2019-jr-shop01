...
var Ajax = (function(){
  ...
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyDXXjJplUtkjqrLN41-Y3YHH-LaDCH8FFw",
    authDomain: "shop01.firebaseapp.com",
    databaseURL: "https://shop01.firebaseio.com",
    projectId: "shop01",
    storageBucket: "shop01.appspot.com",
    messagingSenderId: "633572072347"
  };
...
function blogAdd(data) {
	...
	html += '<li class="grid-tit rt_arrow">'+data.val().name+'</li>';
	html += '</ul>';
	$(".grid").append(html);
...
$(".ghost_bt").click(function(){
	...
	$(this).css({"background-color":"#045321", "color":"#fff", "border":"1px solid #fff"});
	var idx = $(this).index();
